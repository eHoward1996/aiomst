...
export const store = new Vuex.Store({
  ...
  getters: {
    currentArtist: state => {
      return state.gResp["artists"].length === 1 ? state.gResp["artists"][0] : undefined
    },
    artists: state => {
    ...
    currentAlbum: state => {
      return state.gResp["albums"].length === 1 ? state.gResp["albums"][0] : undefined
    },
    albums: state => {
          ...
          .then(response => {
            ...
            var howlInfo = new Howl({
              ...
              onend: function() {
                ...
                // context.commit('updateSongState', null)
